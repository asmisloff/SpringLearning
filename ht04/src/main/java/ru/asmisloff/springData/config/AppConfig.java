package ru.asmisloff.springData.config;
...
@Configuration
@EnableJpaRepositories("ru.asmisloff.springData.repositories")
@EnableTransactionManagement
@ComponentScan("ru.asmisloff.springData")
public class AppConfig {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:h2:file:c:\\Users\\asmisloff\\YandexDisk\\GeekBrains\\Spring\\ht04\\db\\demo;MV_STORE=false");
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("ru.asmisloff.springData.entity");
